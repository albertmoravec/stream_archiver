defmodule StreamArchiverWeb.Router do
  use StreamArchiverWeb, :router

  import StreamArchiverWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {StreamArchiverWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: StreamArchiverWeb.Telemetry
    end
  end
